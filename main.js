...
function start() {
    ...
    d3.csv("movies.csv", function (csv) {
        ...
        // Where details of movie displays
        ...
        var temp1 = chart1.selectAll("circle")
            ...
            .attr("stroke", "black")
            //.attr("fill", "pink")
            .filter(function (d) {return d.title_year == 2012 }) //170051787
            ...
            .on("click", function (d, i) {
                ...
                // Code from P4 brusing - disregard it. I just kept in case if we want to do brushing
